function printExif(dataURL) {
  ...
  if (!(jQuery.isEmptyObject(gpsIfd))) {
      ...
      $('#coordinatesDMSRationalDec').html('Koordinat dalam bentuk DMS sebagai  nomor rasional: ' + coordsDMSRational);
      ...
      $('#coordinatesDMSDec').html('Koordinat dalam bentuk DMS: ' + coordsDMS);
      ...
      $('#coordinatesDecDegreesDec').html('Koordinat dalam bentuk derajat desimal: ' + coordsDecDegrees);
      ...
      $('#encodedMessageDec').html('Pesan yang telah dienkoding dalam bentuk desimal: ' + encodedMessage);
